...
//     //     //     const label = buttonSpan.textContent;
//     //     //     console.log('Button clicked:', label);
//     //     //     if (label === 'SHOP') {
//     //     //         // window.location.href = './sh-op.html';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Assuming there's a container where you want to append these buttons
    // const container = document.getElementById('bs'); // Change 'buttonContainer' to the actual ID of your container
    // buttonSpans.forEach(button => {
    //     container.appendChild(button);
    // });
